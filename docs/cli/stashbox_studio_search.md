## stashbox studio search

SearchStudio (query)

```
stashbox studio search [flags]
```
...
```
  -h, --help          help for search
      --limit limit   convenience: result limit (binds the limit argument)
      --term term     convenience: search term (binds the term argument)
```
